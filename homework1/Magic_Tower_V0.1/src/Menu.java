...
public class Menu {
	...
	public void listAchievements(){
		...
		List<Achievement> achievementList = achievements.getAchievementList();
		System.out.println("Achievement List");
		for (Achievement achievement : achievementList) {
			System.out.print(achievement.getIndex()+"--Name:"+achievement.getName());
			if(achievement.getAchieved()){
				System.out.println("--Achieved:√--Description:"+achievement.getDescription());
			}else{
				System.out.println("--Achieved:x--Description:Locked");
			}
		}
	}
